...
public class WoodenLecternContainer extends Container {
    ...
    public WoodenLecternContainer(int p_i50075_1_) {
        this(p_i50075_1_, new Inventory(1), new IntArray(1));
    }

    public WoodenLecternContainer(int p_i50076_1_, IInventory p_i50076_2_, IIntArray p_i50076_3_) {
        super(ModContainerType.wooden_lectern_container, p_i50076_1_);
