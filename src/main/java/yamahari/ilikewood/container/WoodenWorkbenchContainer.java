...
public class WoodenWorkbenchContainer extends RecipeBookContainer<CraftingInventory> {
    ...
    public WoodenWorkbenchContainer(int p_i50090_1_, PlayerInventory p_i50090_2_) {
        this(p_i50090_1_, p_i50090_2_, IWorldPosCallable.DUMMY);
    }

    public WoodenWorkbenchContainer(int p_i50090_1_, PlayerInventory p_i50090_2_, IWorldPosCallable p_i50090_3_) {
        super(ModContainerType.wooden_workbench_container, p_i50090_1_);
    ...
    public boolean canInteractWith(PlayerEntity p_75145_1_) {
        return field_217070_e.applyOrElse((p_216960_2_, p_216960_3_) -> {
            return !(p_216960_2_.getBlockState(p_216960_3_).getBlock() instanceof WoodenCraftingTable) ?
