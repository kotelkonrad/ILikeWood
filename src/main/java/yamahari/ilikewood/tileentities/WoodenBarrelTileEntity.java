...
public class WoodenBarrelTileEntity extends LockableLootTileEntity {
    ...
    protected ITextComponent getDefaultName() {
        switch (this.woodType) {
            ...
            case DARK_OAK:
                return new TranslationTextComponent("container.ilikewood.dark_oak_barrel");
            case SPRUCE:
                return new TranslationTextComponent("container.ilikewood.spruce_barrel");
            case BIRCH:
                return new TranslationTextComponent("container.ilikewood.birch_barrel");
            case JUNGLE:
    ...
    public void func_213962_h() {
        ...
        if (this.field_213967_b > 0) {
            ...
            if (!(lvt_4_1_.getBlock() instanceof WoodenBarrelBlock)) {
                this.remove();
                return;
            }
